...
import '@turf/inside';
    ...
    const CurrentPosition = (ignoreSundays = true, ignoreSaturday = true, layerDebug) => {

        let changeActivityData;
        let changeActivityCount = 0;

        let changeActivityTolerance = 10; // ~10min
        let currentActivity = EnumActivity.OTHER;
